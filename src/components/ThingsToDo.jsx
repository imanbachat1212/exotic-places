      ...
      <div className='aa'>
                ...
                <div class="list-group">
                  ...
                  <a href="ThingsToDo" class="list-group-item">
                    ...
                    <p class="text"> If you look at our cruise suggestions, you are bound to find a cruise … and destination to suit your style and interests.
                      ...
                      We offer a full range of cruises from the traditional larger cruise ships to river cruises, small vessel eco-cruise experiences, yacht cruises and small boutique sailing vessels. You can even enjoy an African safari by boat! Cruises range from 2 days up to just under 3 weeks.
        ...
        {/* <div class="verticals four">
          <div class="dealwrapper blue">
            <div class="ribbon-wrapper">
              <div class="ribbon-tag">Best views</div>
            </div>
            <div class="list-group">
